...
public:
    ...
    Book(const string& id, const string& title, const string& author,const string& category, const string& publisher, const string& publishDate, const string& price, const string& pages, const string& description);
    Book();
    ~Book();
